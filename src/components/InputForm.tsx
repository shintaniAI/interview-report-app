...
export default function InputForm({ form, error, onUpdateForm, onSubmit, onShowHistory }: InputFormProps) {
...
{/* history button moved to bottom */}
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg shadow-gray-200/50 border border-white/60 p-8 space-y-6">
          <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
            <div className="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center text-orange-600 text-sm font-bold">1</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input type="text" value={form.candidateName} onChange={(e) => onUpdateForm("candidateName", e.target.value)}
                className="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50/50 focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-400 transition-all"
                placeholder="山田 太郎" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2 border-b border-gray-100 pb-3 pt-2">
            <div className="w-8 h-8 bg-teal-100 rounded-lg flex items-center justify-center text-teal-600 text-sm font-bold">2</div>
          ...
          <div>
            <button type="button" onClick={() => setShowOptional(!showOptional)}
              className="flex items-center gap-2 text-orange-600 text-sm font-medium hover:text-orange-800 transition-colors cursor-pointer">
